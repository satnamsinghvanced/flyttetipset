...
export async function generateMetadata() {
    ...
    return generatePageMetadata({
        ...
        description: metaDescription || subHeading || "Learn more about becoming a Flyttetipset partner",
        path: slug || "/partner",
        ...
        ogDescription: ogDescription || metaDescription || subHeading || "Join the Flyttetipset network and collaborate with us",
